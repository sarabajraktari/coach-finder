<template>
    <form @submit.prevent="submitForm">
        <div class="form-control" :class="{invalid: !this.firstName.isValid }">
            ...
            <label v-if="!this.firstName.isValid">Firstname must not be empty!</label>
        </div>
        <div class="form-control" :class="{invalid: !this.lastName.isValid}">
            ...
            <label v-if="!this.lastName.isValid">Lastname must not be empty!</label>
        </div>
        <div class="form-control" :class="{invalid: !this.description.isValid}">
            ...
            <label v-if="!this.description.isValid">Description must not be empty!</label>
        </div>
        <div class="form-control" :class="{invalid: !this.rate.isValid}">
            ...
            <label v-if="!this.rate.isValid">Rate must be greater than 0!</label>
        </div>
        <div class="form-control" :class="{invalid: !this.areas.isValid}">
            ...
            <label v-if="!areas.isValid">At least one experties must be selected</label>
        </div>
